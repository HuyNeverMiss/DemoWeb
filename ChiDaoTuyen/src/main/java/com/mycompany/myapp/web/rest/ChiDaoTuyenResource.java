...
public class ChiDaoTuyenResource {
    ...
    public ResponseEntity<List<ChiDaoTuyenDTO>> getAllChiDaoTuyens(ChiDaoTuyenCriteria criteria) {
        log.debug("REST request to get ChiDaoTuyens by criteria: {}", criteria);
        List<ChiDaoTuyenDTO> entityList = chiDaoTuyenQueryService.findByCriteria(criteria);
