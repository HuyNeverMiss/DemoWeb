...
public class NoiDenCongTacResource {
    ...
    public ResponseEntity<List<NoiDenCongTacDTO>> getAllNoiDenCongTacs(NoiDenCongTacCriteria criteria) {
        log.debug("REST request to get NoiDenCongTacs by criteria: {}", criteria);
        List<NoiDenCongTacDTO> entityList = noiDenCongTacQueryService.findByCriteria(criteria);
