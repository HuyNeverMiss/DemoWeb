...
public class HoTro implements Serializable {
    ...
    @Column(name = "danh_gia_kq_cong_tac")
    ...
    public HoTro kTHoTro(String kTHoTro) {
        this.setkTHoTro(kTHoTro);
        return this;
    }
    ...
    public String getDanhGiaKQCongTac() {
        return this.danhGiaKQCongTac;
    }

    public HoTro danhGiaKQCongTac(String danhGiaKQCongTac) {
        this.setDanhGiaKQCongTac(danhGiaKQCongTac);
        return this;
    }
