...
class LyDoCongTacResourceIT {
    ...
    void createLyDoCongTac() throws Exception {
        ...
        restLyDoCongTacMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(lyDoCongTacDTO))
            )
    ...
    void putWithMissingIdPathParamLyDoCongTac() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restLyDoCongTacMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(lyDoCongTacDTO)))
    ...
    void patchWithMissingIdPathParamLyDoCongTac() throws Exception {
        ...
        restLyDoCongTacMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(lyDoCongTacDTO))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteLyDoCongTac() throws Exception {
        ...
        restLyDoCongTacMockMvc
            .perform(delete(ENTITY_API_URL_ID, lyDoCongTac.getId()).accept(MediaType.APPLICATION_JSON))
