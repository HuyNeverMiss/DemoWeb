...
class KyThuatHoTroResourceIT {
    ...
    void createKyThuatHoTro() throws Exception {
        ...
        restKyThuatHoTroMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(kyThuatHoTroDTO))
            )
    ...
    void putWithMissingIdPathParamKyThuatHoTro() throws Exception {
        ...
        restKyThuatHoTroMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(kyThuatHoTroDTO))
            )
    ...
    void deleteKyThuatHoTro() throws Exception {
        ...
        restKyThuatHoTroMockMvc
            .perform(delete(ENTITY_API_URL_ID, kyThuatHoTro.getId()).accept(MediaType.APPLICATION_JSON))
