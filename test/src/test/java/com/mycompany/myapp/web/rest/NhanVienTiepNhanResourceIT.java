...
class NhanVienTiepNhanResourceIT {
    ...
    void createNhanVienTiepNhan() throws Exception {
        ...
        restNhanVienTiepNhanMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(nhanVienTiepNhanDTO))
            )
    ...
    void putWithMissingIdPathParamNhanVienTiepNhan() throws Exception {
        ...
        restNhanVienTiepNhanMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(nhanVienTiepNhanDTO))
            )
    ...
    void deleteNhanVienTiepNhan() throws Exception {
        ...
        restNhanVienTiepNhanMockMvc
            .perform(delete(ENTITY_API_URL_ID, nhanVienTiepNhan.getId()).accept(MediaType.APPLICATION_JSON))
