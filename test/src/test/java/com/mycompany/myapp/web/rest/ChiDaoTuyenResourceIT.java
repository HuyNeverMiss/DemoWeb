...
class ChiDaoTuyenResourceIT {
    ...
    void createChiDaoTuyen() throws Exception {
        ...
        restChiDaoTuyenMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(chiDaoTuyenDTO))
            )
    ...
    void putWithMissingIdPathParamChiDaoTuyen() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restChiDaoTuyenMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(chiDaoTuyenDTO)))
    ...
    void patchWithMissingIdPathParamChiDaoTuyen() throws Exception {
        ...
        restChiDaoTuyenMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(chiDaoTuyenDTO))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteChiDaoTuyen() throws Exception {
        ...
        restChiDaoTuyenMockMvc
            .perform(delete(ENTITY_API_URL_ID, chiDaoTuyen.getId()).accept(MediaType.APPLICATION_JSON))
