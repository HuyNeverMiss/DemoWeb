...
class HoTroResourceIT {
    ...
    private static final String DEFAULT_K_T_HO_TRO = "AAAAAAAAAA";
    private static final String UPDATED_K_T_HO_TRO = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_DANH_GIA_KQ_CONG_TAC = "AAAAAAAAAA";
    private static final String UPDATED_DANH_GIA_KQ_CONG_TAC = "BBBBBBBBBB";
    ...
    public static HoTro createEntity(EntityManager em) {
        HoTro hoTro = new HoTro()
            ...
            .danhGiaKQCongTac(DEFAULT_DANH_GIA_KQ_CONG_TAC);
        return hoTro;
    }
    ...
    public static HoTro createUpdatedEntity(EntityManager em) {
        HoTro hoTro = new HoTro()
            ...
            .danhGiaKQCongTac(UPDATED_DANH_GIA_KQ_CONG_TAC);
        return hoTro;
    }
    ...
    void createHoTro() throws Exception {
        ...
        restHoTroMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(hoTroDTO)))
        ...
        assertThat(testHoTro.getkTHoTro()).isEqualTo(DEFAULT_K_T_HO_TRO);
        ...
        assertThat(testHoTro.getDanhGiaKQCongTac()).isEqualTo(DEFAULT_DANH_GIA_KQ_CONG_TAC);
    }
    ...
    void getAllHoTros() throws Exception {
        ...
        restHoTroMockMvc
            ...
            .andExpect(jsonPath("$.[*].kTHoTro").value(hasItem(DEFAULT_K_T_HO_TRO)))
            ...
            .andExpect(jsonPath("$.[*].danhGiaKQCongTac").value(hasItem(DEFAULT_DANH_GIA_KQ_CONG_TAC)));
    }
    ...
    void getHoTro() throws Exception {
        ...
        restHoTroMockMvc
            ...
            .andExpect(jsonPath("$.kTHoTro").value(DEFAULT_K_T_HO_TRO))
            ...
            .andExpect(jsonPath("$.danhGiaKQCongTac").value(DEFAULT_DANH_GIA_KQ_CONG_TAC));
    }
    ...
    void putNewHoTro() throws Exception {
        ...
        assertThat(testHoTro.getkTHoTro()).isEqualTo(UPDATED_K_T_HO_TRO);
        ...
        assertThat(testHoTro.getDanhGiaKQCongTac()).isEqualTo(UPDATED_DANH_GIA_KQ_CONG_TAC);
    }
    ...
    void putWithMissingIdPathParamHoTro() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restHoTroMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(hoTroDTO)))
    ...
    void patchWithMissingIdPathParamHoTro() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restHoTroMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(hoTroDTO)))
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteHoTro() throws Exception {
        ...
        // Delete the hoTro
        restHoTroMockMvc
            .perform(delete(ENTITY_API_URL_ID, hoTro.getId()).accept(MediaType.APPLICATION_JSON))
