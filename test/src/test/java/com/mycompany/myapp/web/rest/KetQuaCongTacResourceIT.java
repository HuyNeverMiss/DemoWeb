...
class KetQuaCongTacResourceIT {
    ...
    void createKetQuaCongTac() throws Exception {
        ...
        restKetQuaCongTacMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(ketQuaCongTacDTO))
            )
    ...
    void putWithMissingIdPathParamKetQuaCongTac() throws Exception {
        ...
        restKetQuaCongTacMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(ketQuaCongTacDTO))
            )
    ...
    void deleteKetQuaCongTac() throws Exception {
        ...
        restKetQuaCongTacMockMvc
            .perform(delete(ENTITY_API_URL_ID, ketQuaCongTac.getId()).accept(MediaType.APPLICATION_JSON))
