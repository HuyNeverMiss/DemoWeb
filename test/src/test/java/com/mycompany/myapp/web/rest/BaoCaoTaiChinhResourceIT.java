...
class BaoCaoTaiChinhResourceIT {
    ...
    void createBaoCaoTaiChinh() throws Exception {
        ...
        restBaoCaoTaiChinhMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(baoCaoTaiChinhDTO))
            )
    ...
    void putWithMissingIdPathParamBaoCaoTaiChinh() throws Exception {
        ...
        restBaoCaoTaiChinhMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(baoCaoTaiChinhDTO))
            )
    ...
    void deleteBaoCaoTaiChinh() throws Exception {
        ...
        restBaoCaoTaiChinhMockMvc
            .perform(delete(ENTITY_API_URL_ID, baoCaoTaiChinh.getId()).accept(MediaType.APPLICATION_JSON))
