...
class NoiDenCongTacResourceIT {
    ...
    void createNoiDenCongTac() throws Exception {
        ...
        restNoiDenCongTacMockMvc
            .perform(
                post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(noiDenCongTacDTO))
            )
    ...
    void putWithMissingIdPathParamNoiDenCongTac() throws Exception {
        ...
        restNoiDenCongTacMockMvc
            .perform(
                put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(noiDenCongTacDTO))
            )
    ...
    void deleteNoiDenCongTac() throws Exception {
        ...
        restNoiDenCongTacMockMvc
            .perform(delete(ENTITY_API_URL_ID, noiDenCongTac.getId()).accept(MediaType.APPLICATION_JSON))
