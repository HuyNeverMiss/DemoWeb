...
class VatTuHoTroResourceIT {
    ...
    void createVatTuHoTro() throws Exception {
        ...
        restVatTuHoTroMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(vatTuHoTroDTO)))
    ...
    void putWithMissingIdPathParamVatTuHoTro() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restVatTuHoTroMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(vatTuHoTroDTO)))
    ...
    void patchWithMissingIdPathParamVatTuHoTro() throws Exception {
        ...
        restVatTuHoTroMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(vatTuHoTroDTO))
            )
            .andExpect(status().isMethodNotAllowed());
    ...
    void deleteVatTuHoTro() throws Exception {
        ...
        restVatTuHoTroMockMvc
            .perform(delete(ENTITY_API_URL_ID, vatTuHoTro.getId()).accept(MediaType.APPLICATION_JSON))
